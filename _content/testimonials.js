module.exports = {
	load: ({slug}) => {
		switch(slug) {
			...
			case 'jeorme-2018-04-02': return require('../_content/testimonials/jeorme-2018-04-02.json');

			case 'sally-bery-2018-04-02': return require('../_content/testimonials/sally-bery-2018-04-02.json');
